    ...
    <div  v-show="measureComb">
      <div>
        <div class="sm-measure-btn-list">
          ...
          <button @click="heightClk" class="sm-btn sm-measure-btn" id="height" title="高度" type="button">
...
export default {
  ...
  computed: {
    measureComb: function () {
      return this.sharedState.componentShow[this.index];
    },
  ...
  created() {
    let cName = this.sharedState.componentName;
    let cShow = this.sharedState.componentShow;
    let cType = this.sharedState.componentType;
